...
export function TweaksPanel({ title = 'Tweaks', children, defaultOpen = true }) {
      ...
      <>
        ...
        <button
          ...
          style={{
            ...
            background: 'rgba(250,249,247,0.9)', border: '.5px solid rgba(255,255,255,.6)',
            borderRadius: 10, padding: '8px 14px', cursor: 'pointer',
            font: '11.5px/1.4 ui-sans-serif,system-ui,sans-serif', fontWeight: 600,
            color: '#29261b', boxShadow: '0 4px 16px rgba(0,0,0,.15)',
